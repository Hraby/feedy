          ...
          <div className="flex items-center gap-4 ml-auto">
            ...
            <div className="relative">
              ...
              {activeDropdown === "locations" && (
                <div className="absolute right-0 mt-2 w-72 bg-white shadow-2xl rounded-2xl p-2 z-40 transition-all duration-500 ease-in-out">
            ...
            <div className="relative">
              ...
              {activeDropdown === "cart" && (
                <div className="absolute right-0 mt-2 w-72 bg-white shadow-2xl rounded-2xl p-2 z-40">
