...
const LandingNavbar = () => {
  ...
  return (
    <nav
      className={`py-4 bg-white fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
    ...
    >
      <div className="container mx-auto px-6 md:px-10 lg:px-4 flex justify-between items-center">
        ...
        <div
          className={`md:flex gap-4 transition-transform duration-300 ease-in-out ${
            menuOpen
